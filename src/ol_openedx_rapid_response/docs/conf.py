...
"""
ol_openedx_rapid_response documentation build configuration file.
...
VERSION = get_version('../ol_openedx_rapid_response/ol_openedx_rapid_response', '__init__.py')
...
project = 'ol_openedx_rapid_response'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'ol_openedx_rapid_response'
...
#
# html_title = 'ol_openedx_rapid_response v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'ol_openedx_rapid_response'),
                os.path.join(root_path, 'ol_openedx_rapid_response/migrations')])
